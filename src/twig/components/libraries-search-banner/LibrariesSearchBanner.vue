<template>
    <div
        class="tabbable tabs-left mb-[-100px] pt-6 pl-6 p-0 flex flex-col sm:flex-row justify-center bg-colbyBlue text-white"
        id="librarysearch"
    >
        ...
        <section class="content-section sm:w-[600px] relative">
