        ...
        >
            ...
            >
                ...
                <a
                    ...
                    >LibrarySearch</a
                >
                to search for books, articles, and other library materials
            </p>
            <div v-if="query">
    ...
    export default {
        ...
        props: {
            id: {
                type: String,
                required: false,
                default: 'prod_libraries_redesign_searchable_posts',
            },
            suggestions: {
                type: String,
                required: false,
                default: 'prod_libraries_redesign_searchable_posts_query_suggestions',
            },
        },
        methods: {
            search(query) {
